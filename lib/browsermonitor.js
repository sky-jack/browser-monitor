...
(function() {
	var cli, differ, webdriver, options, async, assert, events, browser, parseCommandLine, getGroup, initParallelDevices, parseImages, diffImages, theDrivers, urls, mailUser;
